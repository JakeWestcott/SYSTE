...
public class MainScreen extends javax.swing.JFrame {
    ...
    public MainScreen() {
        initComponents();
        connectClient_toServer();
        connectClient_toChatServer();
    }
    ...
    public void connectClient_toServer(){
            try{
      ...
      System.out.println("There has been an IOException");
       ...
       public void connectClient_toChatServer(){
            try{
            Socket chatServer = new Socket("localhost", 9898);
